    ...
    <div class="addModal">
            <div class="dispatch-container">
                        ...
                        <div class="nav-right">
                            <div class="nav-body">
                                ...
                                <div v-else style="width: 100%; text-align: center">
                                    <el-button type="primary" @click="startScreenshoting" class="start-button">开始截屏</el-button>
                                </div>
                            </div>

                            <footer class="paginator-footer">
                                <el-row type="flex" justify="center">
                                    <div  v-if="pagination.pageCount > 1 && selectedSourceType !== 6" class="paginator">
                                        <el-pagination
                                                small
                ...
                <main class="screen-part">
                    <section class="screens-list">
                        <div v-if="servers.length" class="screens-inner">
                            <div
                    ...
                    <div class="datav-footer">
                        <el-button type="primary" @click="handleCastToScreen(1)">投屏</el-button>
                    </div>
                </main>
            </div>
    </div>
...
<script>
    ...
    export default {
        ...
        created(){
             if(this.$route.query.serverId&&this.$route.query.type){
           ...
           async selectSourceType(type) {
            ...
            async handleCastToScreen(castType) {
                ...
                if (this.selectedSourceType === 6) {
                    ...
                    this.clearSearchForm();
                    this.isTemporalyCast = true;
                    setTimeout(() => this.selectSourceType(6),  10);
                } else {
            ...
            startScreenshoting() {
                if (this.userCastType === 1) {
                    if (!this.selectedServerIdx) {
                        this.$message.error('请选择服务器！');
                    }
                } else {
                    if (!this.selectedServerIdx && !this.selectedScreenItemId) {
                        this.$message.error('请选择服务器和场景项！');
                    }
                }
            }
        }
