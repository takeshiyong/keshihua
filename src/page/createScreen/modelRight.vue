<template>
    <div class="right-contents" ref="rightContent" @mousedown.stop @click="doThis()">
        ...
        <div class="right-r-content">
            ...
            <div style="padding: 0 20px">
                <div v-if="isSelectedComponent">
                    <div class="toolbar-wh-row">
                        <p class="toolbar-row-title">位置</p>
                        <span class="toolbar-position-inp">top
                        <el-input-number v-if="!showTemplate" :disabled="true" :value="top" @change="changeTop" size="mini" controls-position="right" :min="0" :max="20000"></el-input-number>
                        <el-input-number v-else :value="top" @change="changeTop" size="mini" controls-position="right" :min="0" :max="20000"></el-input-number>
                        </span>
                        <span class="toolbar-position-inp">left
                        <el-input-number v-if="!showTemplate" :disabled="true" :value="left" @change="changeLeft" size="mini" controls-position="right" :min="0" :max="20000"></el-input-number>
                        <el-input-number v-else :value="left" @change="changeLeft" size="mini" controls-position="right" :min="0" :max="20000"></el-input-number>
                    ...
                    <div class="toolbar-wh-row">
                        ...
                        <el-input-number v-if="!showTemplate" :disabled="true" :value="width" @change="changeWidth" size="mini" controls-position="right" :min="0" :max="20000"></el-input-number>
                        <el-input-number v-else :value="width" @change="changeWidth" size="mini" controls-position="right" :min="0" :max="20000"></el-input-number>
                        </span>
                        <span class="toolbar-size-inp">height
                        <el-input-number v-if="!showTemplate" :disabled="true" :value="height" @change="changeHeight" size="mini" controls-position="right" :min="0" :max="20000"></el-input-number>
                        <el-input-number v-else :value="height" @change="changeHeight" size="mini" controls-position="right" :min="0" :max="20000"></el-input-number>
...
<script>
    ...
    export default {
        ...
        mounted(){
            this.newScreenDetail=this.screenDetail;
            this.getActiveValue();
        },
        computed: {
            ...
            activeName() {
                ...
                ? ""
                : this.resourceList[this.activeRect].resource.fResourceName;
            },
            width() {
                return this.activeRect === null
                ? ""
                : this.resourceList[this.activeRect].width
            },

            height() {
                return this.activeRect === null
                ? ""
                : this.resourceList[this.activeRect].height
            },

            top() {
                return this.activeRect === null
                ? ""
                : this.resourceList[this.activeRect].top
            },

            left() {
                return this.activeRect === null
                ? ""
                : this.resourceList[this.activeRect].left
            },
            zIndex() {
                ...
                return this.resourceList[this.activeRect].zIndex === 1
                ? "isFirst"
                : this.resourceList[this.activeRect].zIndex === this.resourceList.length
                ? "isLast"
                : "normal";
            }
        },
        methods: {
            ...
            getActiveValue() {
                let that = this;
                bus.$on("isSelectedComponent", function(val) {
                    that.isSelectedComponent = val;
                });
            },
            toTop() {
            ...
            changeTop(val) {
                ...
                if (typeof top !== "number" || isNaN(top)) {
                    top = this.resourceList[this.activeRect].top;
                    ev.target.value = top;
                    return;
                }
            ...
            changeLeft(val) {
                ...
                if (typeof left !== "number" || isNaN(left)) {
                    left = this.resourceList[this.activeRect].left;
            ...
            changeWidth(val) {
                ...
                if (typeof width !== "number" || isNaN(width)) {
                    width = this.resourceList[this.activeRect].width;
                ...
                //     width: width
                // });
                this.resourceList[this.activeRect].width = width;
            ...
            changeHeight(val) {
                ...
                if (typeof height !== "number" || isNaN(height)) {
                    height = this.resourceList[this.activeRect].height;
            ...
            changeScreenWidth(val) {
                ...
                bus.$emit("onScreenChange", this.screen);
            },
...
<style>
    .el-input-number__decrease .el-icon-arrow-down{
